...
#     drug_data: pd.DataFrame = ChemblDBIndications()._preprocess(ChemblDBIndications()._load_data(), max_length=max_length)
#     chemreps_data: list[str] = ChemblDBChemreps()._preprocess(ChemblDBChemreps()._load_or_download(), continuous=False)[::10]
