...
class SmilesBidirectionalIndGeneratorRNNConfig(SmilesGLMConfig):
...
class SmilesBidirectionalIndGeneratorRNN(SmilesGenerativeLanguageModel):

    def __init__(self, config: SmilesBidirectionalIndGeneratorRNNConfig):
        """
